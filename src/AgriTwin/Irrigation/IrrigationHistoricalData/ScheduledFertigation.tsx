       ...
       <CardHeader className="bg-gradient-to-br from-green-100 to-blue-100 dark:from-green-900/50 dark:to-blue-900/50 p-4 sm:p-6 rounded-t-2xl">
            ...
            <div>
              ...
              <CardDescription className="text-base text-green-700 dark:text-blue-200">
                Smart NPK levels management system
              </CardDescription>
            </div>
                ...
                <table className="w-full min-w-[640px]">
                  <thead className="bg-green-50 dark:bg-gray-800/50">
                    <tr>
                      ...
                      <th className="py-3 px-4 text-left text-sm font-medium text-green-800 dark:text-blue-300">NPK</th>
                  ...
                  <tbody>
                    {schedules.map((schedule, index) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-4">
                          <div className="space-y-1">
                            <span className="text-green-700 dark:text-blue-200">{schedule.NPK}</span>
                          </div>
                        </td>
                        <td className="py-4 px-4">
...
export default ScheduledFertigation;